...
class WorriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worry" do
    assert_difference('Worry.count') do
      post user_worries_url(@user), params: { worry: { description: @worry.description, recording_url: @worry.recording_url, user_id: 1  } }, as: :json
    end
  ...
  test "should update worry" do
    patch user_worry_url(@user, @worry), params: { worry: { description: @worry.description, recording_url: @worry.recording_url } }, as: :json
    assert_response 200
  end
